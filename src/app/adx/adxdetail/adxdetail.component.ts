...
@Component({
  selector: 'app-adxdetail',
  templateUrl: './adxdetail.component.html',
  styleUrls: ['./adxdetail.component.css']
})
export class AdxdetailComponent implements OnInit {
  ...
  ngOnInit() {
    this.jobName = "Adx";
    this.urlPage='http://83.66.131.71:1071/api/schedules';
    this.scheduleTriggerUrl= 'http://83.66.131.71:1971/api/triggers/schedule';
    this.getJobDetail();
