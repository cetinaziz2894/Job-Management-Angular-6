...
@Component({
  selector: 'app-adx',
  templateUrl: './adx.component.html',
  styleUrls: ['./adx.component.css'],
})



export class AdxComponent implements OnInit {
  ...
  components  = [
    {
      ...
      serviceCallName:"adxjob",
      healthyUrl:"http://83.66.131.71:1071/healthcheck",
      routeDetailUrl:"http://83.66.131.71:1071/api/schedules",
      statisticUrl:"http://83.66.131.71:1299/api/jobs/adxjob/statistics",
      historiesLast:"http://83.66.131.71:1299/api/jobs/adxjob/histories/last",
      routeDetail:"detail"}
  ];
  ...
  setChart(label,series){
    var canvas = document.getElementById("lineChartAdx");
