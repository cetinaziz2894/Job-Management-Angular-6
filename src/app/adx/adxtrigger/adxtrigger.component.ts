...
@Component({
  selector: 'app-adxtrigger',
  templateUrl: './adxtrigger.component.html',
  styleUrls: ['./adxtrigger.component.css']
})
export class AdxtriggerComponent implements OnInit {
  ...
  httpPostADXCall(item) {
    this.httpClient.post("http://83.66.131.71:1071/api/triggers/manuel",
      {
