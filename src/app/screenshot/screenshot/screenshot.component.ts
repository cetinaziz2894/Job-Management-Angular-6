...
export class ScreenshotComponent implements OnInit {
  ...
  components  = [
    {
      ...
      serviceCallName:"screenshotjob",
      healthyUrl:"http://83.66.131.71:1917/healthcheck",
      routeDetailUrl:"http://83.66.131.71:1917/api/schedules",
      statisticUrl:"http://83.66.131.71:1299/api/jobs/screenshotjob/statistics",
      historiesLast:"http://83.66.131.71:1299/api/jobs/screenshotjob/histories/last",
      routeDetail:"detail"}
  ];
  ...
  setChart(label,series){
    var canvas = document.getElementById("lineChartScreenshot");
