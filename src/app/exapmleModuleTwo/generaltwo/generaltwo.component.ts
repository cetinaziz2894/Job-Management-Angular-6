...
@Component({
  selector: 'app-generaltwo',
  templateUrl: './generaltwo.component.html',
  styleUrls: ['./generaltwo.component.css']
})
export class GeneraltwoComponent implements OnInit {
...
/*
  ...
  */
  ...
  setChart(label,series){
    var canvas = document.getElementById("lineChartExampleTwo");
