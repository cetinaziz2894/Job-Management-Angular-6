...
export class CampaignComponent implements OnInit {
  ...
  components  = [
    {
      name: "CAMPAIGN",
      jobname:"CAMPAIGN TRANSFER",
      icon: "cached",
      routeTrigger:"trigger",
      routeHistory:"histories",
      cardClass:"card-header-danger",
      cardIconClass:"card-header-light-purple",
      serviceCallName:"campaigntransferjob",
      healthyUrl:"http://83.66.131.71:1916/healthcheck",
      routeDetailUrl:"http://83.66.131.71:1916/api/schedules",
      statisticUrl:"http://83.66.131.71:1299/api/jobs/campaigntransferjob/statistics",
      historiesLast:"http://83.66.131.71:1299/api/jobs/campaigntransferjob/histories/last",
      routeDetail:"detail"}
  ];
  ...
  setChart(label,series){
    var canvas = document.getElementById("lineChartCampaignTransfer");
