...
export class ReservationComponent implements OnInit {
  ...
  components  = [
    {
      ...
      serviceCallName:"reservationjob",
      healthyUrl:"http://83.66.131.71:1915/healthcheck",
      routeDetailUrl:"http://83.66.131.71:1915/api/schedules",
      statisticUrl:"http://83.66.131.71:1299/api/jobs/reservationjob/statistics",
      historiesLast:"http://83.66.131.71:1299/api/jobs/reservationjob/histories/last",
      routeDetail:"detail"}
  ];
  ...
  setChart(label,series){
    ...
    var canvas = document.getElementById("lineChartReservation");
  ...
  getHistoriesLast(item){
    this.httpClient.get(item, { responseType:'json' }).subscribe((response: any) => {
      ...
      if(this.LastHistoriesInfo.length == 0)
      {
        this.isEmpty =true;
      }
      else{
