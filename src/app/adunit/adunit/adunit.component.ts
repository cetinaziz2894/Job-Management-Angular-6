...
@Component({
  selector: 'app-adunit',
  templateUrl: './adunit.component.html',
  styleUrls: ['./adunit.component.css']
})
export class AdunitComponent implements OnInit {
  ...
  components  = [
    {
      name: "ADUNITSYNC",
      jobname:"AD UNIT SYNC",
      icon: "add_box",
      routeTrigger:"trigger",
      routeHistory:"histories",
      cardClass:"card-header-danger",
      cardIconClass:"card-header-light-purple",
      serviceCallName:"adunitsyncjob",
      healthyUrl:"http://83.66.131.71:1919/healthcheck",
      routeDetailUrl:"http://83.66.131.71:1919/api/schedules",      
      statisticUrl:"http://83.66.131.71:1299/api/jobs/adunitsyncjob/statistics",
      historiesLast:"http://83.66.131.71:1299/api/jobs/adunitsyncjob/histories/last",
      routeDetail:"detail"}
  ];
  ...
  setChart(label,series){
    var canvas = document.getElementById("lineChartAdUnit");
