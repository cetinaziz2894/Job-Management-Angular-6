...
@Component({
  selector: 'app-adunitdetail',
  templateUrl: './adunitdetail.component.html',
  styleUrls: ['./adunitdetail.component.css']
})
export class AdunitdetailComponent implements OnInit {
  ...
  ngOnInit() {
    this.jobName = "Adunit Sync";
    this.urlPage='http://83.66.131.71:1919/api/schedules';
    this.scheduleTriggerUrl= 'http://83.66.131.71:1919/api/triggers/schedule';
    this.getJobDetail();
  }
