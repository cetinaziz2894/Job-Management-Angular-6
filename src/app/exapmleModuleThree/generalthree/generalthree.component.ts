...
@Component({
  selector: 'app-generalthree',
  templateUrl: './generalthree.component.html',
  styleUrls: ['./generalthree.component.css']
})
export class GeneralthreeComponent implements OnInit {
  ...
  components  = [
    {
      ...
      historiesLast:"https://35fa1270-24b7-4f55-9c43-facb202c79c6.mock.pstmn.io/last",
      routeDetail:"detail"}
  ];
...
/*
  ...
  */
  ...
  setChart(label,series){
    var canvas = document.getElementById("lineChartExampleThree");
