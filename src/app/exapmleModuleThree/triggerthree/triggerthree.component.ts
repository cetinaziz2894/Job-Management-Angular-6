...
@Component({
  selector: 'app-triggerthree',
  templateUrl: './triggerthree.component.html',
  styleUrls: ['./triggerthree.component.css']
})
export class TriggerthreeComponent implements OnInit {
